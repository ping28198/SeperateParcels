...
int CBasicDemoDlg::SaveImage()
{
    ...
    {
        sprintf_s(chImageName, IMAGE_NAME_LEN, "Image_w%d_h%d_fn%03d.bmp", stParam.nWidth, stParam.nHeight, nFrameNum);
    }
    else if (MV_Image_Jpeg == stParam.enImageType)
    {
        sprintf_s(chImageName, IMAGE_NAME_LEN, "Image_w%d_h%d_fn%03d.jpg", stParam.nWidth, stParam.nHeight, nFrameNum);
    }
