...
public:
	...
	void trace_image(MV_DISPLAY_FRAME_INFO* pFrameInfo, int nUsingDeviceNum, std::string save_filepath, void* pParent);
	double average_pix_base[4][6] = { 0 };
	cv::Mat preMat[4];
	int saved_img_num[4] = { 0 };
...
public:
    int ThreadFun(int nUsingDeviceNum, void* pParent);
