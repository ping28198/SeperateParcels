...
///
/// Returns:
/// * `Output`: Bool, whether to continue bias centering.
class BoostedTreesCenterBias {
 public:
  BoostedTreesCenterBias(const ::tensorflow::Scope& scope, ::tensorflow::Input
                       tree_ensemble_handle, ::tensorflow::Input
                       mean_gradients, ::tensorflow::Input mean_hessians,
                       ::tensorflow::Input l1, ::tensorflow::Input l2);
  operator ::tensorflow::Output() const { return continue_centering; }
  operator ::tensorflow::Input() const { return continue_centering; }
  ::tensorflow::Node* node() const { return continue_centering.node(); }

  ::tensorflow::Output continue_centering;
};
...
///
/// Returns:
/// * `Output`: Output rank 1 Tensor containing a proto serialized as a string for each example.
class BoostedTreesExampleDebugOutputs {
 public:
  BoostedTreesExampleDebugOutputs(const ::tensorflow::Scope& scope,
                                ::tensorflow::Input tree_ensemble_handle,
                                ::tensorflow::InputList bucketized_features,
                                int64 logits_dimension);
  operator ::tensorflow::Output() const { return examples_debug_outputs_serialized; }
  operator ::tensorflow::Input() const { return examples_debug_outputs_serialized; }
  ::tensorflow::Node* node() const { return examples_debug_outputs_serialized.node(); }

  ::tensorflow::Output examples_debug_outputs_serialized;
};
