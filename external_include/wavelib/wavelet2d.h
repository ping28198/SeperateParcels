...
EXPORT void downsamp_OMP(vector<double> &, int, vector<double> &);
...
EXPORT void* dwt2(string ,vector<vector<double> > &, vector<vector<double> >  &,
                vector<vector<double> >  &, vector<vector<double> > &, vector<vector<double> > &);
EXPORT void* dwt2_OMP(string, vector<vector<double> > &, vector<vector<double> >  &,
	vector<vector<double> >  &, vector<vector<double> > &, vector<vector<double> > &);
...
EXPORT double convfftm_OMP(vector<double> &, vector<double> &, vector<double> &);
...
EXPORT void* dwt_2d(vector<vector<double> > &, int , string , vector<double> &, vector<double> & ,
                vector<int> &);
EXPORT void* dwt_2d_OMP(vector<vector<double> > &, int, string, vector<double> &, vector<double> &,
	vector<int> &);

EXPORT void* dwt1_m(string wname, vector<double> &signal, vector<double> &cA, vector<double> &cD) ;
EXPORT void* dwt1_m_OMP(string wname, vector<double> &signal, vector<double> &cA, vector<double> &cD);
